 ...
 */
public class PlayActivityWormy extends AppCompatActivity implements WormyView.WormyListener, SensorEventListener, CountDownButton.CountDownListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customPlaybtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                soundPool.play(PlayActivityWormy.this.intro , 1f, 1f, 1, 0, 1f);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URL_REGISTER_VER,
                new Response.Listener<String>() {
                    @Override public void onResponse(String response) {
                        ...
                        if (apiResponse.getErrorCode() == 2) {
                            HelperUser.getInstance(PlayActivityWormy.this).errorToken(PlayActivityWormy.this);
                            ...
                            toast.show();
                            HelperUser.getInstance(PlayActivityWormy.this).updatePlayer(false);
                        }else{
            ...
            @Override public void onErrorResponse(VolleyError error) {
                ...
                SnackbarManager.show(
                        Snackbar.with(PlayActivityWormy.this)
            ...
            @Override protected Map<String, String> getParams() {
                ...
                try {
                    params.put("token", HelperUser.getInstance(PlayActivityWormy.this).getToken());
    ...
    public void gameLost(View view, int score) {
        ...
        customCuestion.setPreguntaLisener(new CustomCuestion.PreguntaLisener() {
            ...
            public void rechazar() {
                customCuestion.setVisibility(View.INVISIBLE);
                Intent intent = new Intent(PlayActivityWormy.this, HomeActivity.class);
